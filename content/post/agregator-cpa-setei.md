...
Библиотеки, описанные выше, будем использовать для создания "Космического корабля" - приложения которое будет загружать оффера из CPA нетворков и отдавать случайный оффер для показа. Офферама будут проставляться веса для взвешанного случайного выбора.
